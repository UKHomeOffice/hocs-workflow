...
public class CaseworkClient {
    ...
    public GetCaseworkCaseDataResponse getCase(UUID caseUUID) {
        try {
            ...
            throw new ApplicationExceptions.EntityNotFoundException(String.format("Could not get Case %s. %s", caseUUID, e.getMessage()), CASEWORK_CLIENT_CASE_NOT_FOUND);
        }
    }
    ...
    public void createCaseNote(UUID caseUUID, String type, String text) {
        ...
        try {
            ...
            throw new ApplicationExceptions.EntityCreationException(String.format("Could not create Note for Case %s. %s",  caseUUID, e.getMessage()), CASEWORK_CLIENT_CASE_NOTE_CREATION_FAILURE);
        }
    }
    ...
    public UUID createStage(UUID caseUUID, StageType stageType, UUID teamUUID, String allocationType) {
        ...
        try {
            ...
            throw new ApplicationExceptions.EntityCreationException(String.format("Could not create Stage %s for Case %s. %s", stageType, caseUUID, e.getMessage()), CASEWORK_CLIENT_STAGE_CREATION_FAILURE);
        }
    }
    ...
    public UUID getStageUser(UUID caseUUID, UUID stageUUID) {
        try {
            ...
            throw new ApplicationExceptions.EntityNotFoundException(String.format("Could not get User for Stage %s. %s", stageUUID, e.getMessage()), CASEWORK_CLIENT_STAGE_USER_NOT_FOUND);
        }
    }
    ...
    public void updateStageTeam(UUID caseUUID, UUID stageUUID, UUID teamUUID, String allocationType) {
        ...
        try {
            ...
            throw new ApplicationExceptions.EntityCreationException(String.format("Could not update Stage %s Team to %s. %s", stageUUID, teamUUID, e.getMessage()), CASEWORK_CLIENT_STAGE_TEAM_UPDATE_FAILURE);
        }
    }
    ...
    public UUID getStageTeam(UUID caseUUID, UUID stageUUID) {
        try {
            ...
            throw new ApplicationExceptions.EntityNotFoundException(String.format("Could not get Team for Stage %s. %s", stageUUID, e.getMessage()), CASEWORK_CLIENT_STAGE_NOT_FOUND);
        }
    }
}
