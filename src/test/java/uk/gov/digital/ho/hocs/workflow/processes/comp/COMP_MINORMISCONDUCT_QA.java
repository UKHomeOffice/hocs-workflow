...
public class COMP_MINORMISCONDUCT_QA {
    ...
    public void testAcceptRoute() {
        ...
        verify(bpmnService).updateTeamByStageAndTexts(any(), any(), eq("COMP_MINORMISCONDUCT_SEND"),
    ...
    public void testRejectRoute() {
        ...
        when(minorMisconductProcess.waitsAtUserTask("Validate_Reject")).thenReturn(
    ...
    public void testRejectBackAcceptRoute() {
        ...
        verify(bpmnService, never()).updateTeamByStageAndTexts(any(), any(), eq("COMP_MINORMISCONDUCT_DRAFT"),
            eq("QueueTeamUUID"), eq("QueueTeamName"), eq("Stage"));
    }
