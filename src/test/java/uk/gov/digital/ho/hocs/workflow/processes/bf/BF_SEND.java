...
@Deployment(resources = "processes/BF/BF_SEND.bpmn")
public class BF_SEND {
    ...
    public void testHappyPath(){
        ...
        Scenario.run(process).startByKey("BF_SEND").execute();
        verify(process).hasCompleted("EndEvent_BF_SEND");
    }
}
