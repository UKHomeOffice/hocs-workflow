...
@Deployment(resources = { "processes/POGR/POGR_GRO_ESCALATE.bpmn" })
public class POGR_GRO_ESCALATE {
    ...
    public void testHappyPath() {
        ...
        Scenario.run(processScenario).startByKey("POGR_GRO_ESCALATE").execute();
