...
public class COMP_EXGRATIA_QA {
    ...
    public void testAcceptRoute() {
        ...
        verify(bpmnService).updateTeamByStageAndTexts(any(), any(), eq("COMP_EXGRATIA_SEND"), eq("QueueTeamUUID"),
    ...
    public void testRejectRoute() {
        ...
        when(exGratiaProcess.waitsAtUserTask("Validate_Reject")).thenReturn(
    ...
    public void testRejectBackAcceptRoute() {
        ...
        verify(bpmnService, never()).updateTeamByStageAndTexts(any(), any(), eq("COMP_EXGRATIA_DRAFT"),
            eq("QueueTeamUUID"), eq("QueueTeamName"), eq("Stage"));
    }
