...
@Deployment(resources = { "processes/POGR2/POGR2.bpmn", "processes/STAGE.bpmn" })
public class POGR2 {
    ...
    public void testHappyHmpoPath() {
        whenAtCallActivity("POGR2_REGISTRATION").thenReturn("BusinessArea", "HMPO").deploy(rule);

        whenAtCallActivity("POGR2_HMPO").deploy(rule);

        Scenario.run(processScenario).startByKey("POGR2").execute();
    ...
    public void testHappyGroPath() {
        whenAtCallActivity("POGR2_REGISTRATION").thenReturn("BusinessArea", "GRO").deploy(rule);

        whenAtCallActivity("POGR2_GRO").deploy(rule);
