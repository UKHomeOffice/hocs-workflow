...
@Deployment(resources = { "processes/POGR/POGR_HMPO_ESCALATE.bpmn" })
public class POGR_HMPO_ESCALATE {
    ...
    public void testHappyPath() {
        ...
        Scenario.run(processScenario).startByKey("POGR_HMPO_ESCALATE").execute();
