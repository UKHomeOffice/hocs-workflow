...
@Deployment(resources = { "processes/POGR/POGR_HMPO_INVESTIGATION.bpmn" })
public class POGR_HMPO_INVESTIGATION {
    ...
    public void testHappyPath() {
        ...
        when(processScenario.waitsAtUserTask("Screen_Investigation")).thenReturn(
            task -> task.complete(withVariables("DIRECTION", ""))).thenReturn(
            task -> task.complete(withVariables("DIRECTION", "BACKWARD"))).thenReturn(
            task -> task.complete(withVariables("DIRECTION", "FORWARD", "InvestigationOutcome", "Pending"))).thenReturn(
            task -> task.complete(withVariables("DIRECTION", "FORWARD", "InvestigationOutcome", "Draft")));

        Scenario.run(processScenario).startByKey("POGR_HMPO_INVESTIGATION").execute();
    ...
    public void testRejectCase() {
        when(processScenario.waitsAtUserTask("Screen_InvestigationAcceptCase")).thenReturn(
            task -> task.complete(withVariables("InvestigationAccept", "Reject"))).thenReturn(task -> task.complete(
            withVariables("InvestigationAccept", "Reject", "CaseNote_InvestigationReject", "Test")));
    ...
    public void testInvestigationEscalate() {
        when(processScenario.waitsAtUserTask("Screen_InvestigationAcceptCase")).thenReturn(
            task -> task.complete(withVariables("DIRECTION", "FORWARD", "InvestigationAccept", "Accept")));

        when(processScenario.waitsAtUserTask("Screen_Investigation")).thenReturn(task -> task.complete(
            withVariables("DIRECTION", "FORWARD", "InvestigationOutcome", "Escalate"))).thenReturn(
            task -> task.complete(withVariables("DIRECTION", "FORWARD", "InvestigationOutcome", "Escalate")));
    ...
    public void testCloseCase() {
        ...
        when(processScenario.waitsAtUserTask("Screen_Investigation")).thenReturn(
            task -> task.complete(withVariables("DIRECTION", "FORWARD", "InvestigationOutcome", "Complete")));
