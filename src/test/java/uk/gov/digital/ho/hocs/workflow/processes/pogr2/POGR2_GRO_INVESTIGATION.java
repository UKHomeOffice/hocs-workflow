...
public class POGR2_GRO_INVESTIGATION {
    ...
    public void testHappyPath() {
        ...
        whenAtCallActivity("POGR_GRO_PRIORITY_CHANGE_SCREEN")
                ...
                .thenReturn("DIRECTION", "FORWARD","InvestigationOutcome", "Pending")
                .thenReturn("DIRECTION", "FORWARD","InvestigationOutcome", "Draft")
                .deploy(rule);
    ...
    public void testInvestigationExternalRejection() {
        ...
        verify(bpmnService, times(0)).updateTeamByStageAndTexts(any(), any(), eq("POGR2_GRO_INVESTIGATION"), any(), any(), any());
    }
    ...
    public void testInvestigationEscalate() {
        ...
        whenAtCallActivity("POGR_GRO_PRIORITY_CHANGE_SCREEN")
                .thenReturn("DIRECTION", "FORWARD", "InvestigationOutcome", "Escalate")
                .thenReturn("DIRECTION", "FORWARD", "InvestigationOutcome", "Escalate")
                .deploy(rule);
        ...
        when(processScenario.waitsAtUserTask("Screen_GroEscalateScreen"))
                ...
                .thenReturn(task -> task.complete(withVariables(
                        "DIRECTION","FORWARD",
                        "CaseNote_InvestigationEscalate", "Test")));
