...
@Deployment(resources = { "processes/POGR2/POGR2_GRO_INVESTIGATION.bpmn" })
public class POGR2_GRO_INVESTIGATION {
    ...
    public void testHappyPath() {
        ...
        Scenario.run(processScenario).startByKey("POGR2_GRO_INVESTIGATION").execute();

        verify(processScenario).hasCompleted("StartEvent_POGR2_GRO_INVESTIGATION");
        ...
        verify(processScenario).hasCompleted("EndEvent_POGR2_GRO_INVESTIGATION");
    }
    ...
    public void testInvestigationExternalRejection() {
        ...
        verify(bpmnService, times(0)).updateTeamByStageAndTexts(any(), any(), eq("POGR2_GRO_INVESTIGATION"), any(),
            any(), any());
    }
    ...
    public void testInvestigationInternalRejection() {
        ...
        verify(bpmnService).updateAllocationNote(any(), any(), eq("Test"), eq("REJECT"));
        verify(bpmnService).updateTeamByStageAndTexts(any(), any(), eq("POGR2_GRO_INVESTIGATION"), eq("DraftTeamUUID"),
