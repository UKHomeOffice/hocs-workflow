...
@Deployment(resources = { "processes/POGR2/POGR2_GRO_ESCALATE.bpmn" })
public class POGR2_GRO_ESCALATE {
    ...
    public void testHappyPath() {
        ...
        Scenario.run(processScenario).startByKey("POGR2_GRO_ESCALATE").execute();

        verify(processScenario).hasCompleted("EndEvent_GroEscalate");
    }
