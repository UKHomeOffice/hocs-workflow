...
public class DCU_MIN_DTEN_Markup_Common {
    ...
    public void shouldSaveDraftAndPolicyTeamWhenPRAndWhenNotOverride(ProcessScenario dcuMinSignOffProcess, String key, BpmnService bpmnService, String stagePrefix) {

        setupMarkupFor("PR", dcuMinSignOffProcess);

        when(dcuMinSignOffProcess.waitsAtUserTask("VALIDATE_DCU_ANSWERING_PR"))
    ...
    public void shouldSaveDraftAndPolicyTeamWhenPRAndWhenOverride(ProcessScenario dcuMinSignOffProcess, String key, BpmnService bpmnService, String stagePrefix) {
    ...
    public void shouldSaveDraftAndPolicyTeamWhenFAQAndWhenNotOverride(ProcessScenario dcuMinSignOffProcess, String key, BpmnService bpmnService, String stagePrefix) {
    ...
    public void shouldSaveDraftAndPolicyTeamWhenFAQAndWhenOverride(ProcessScenario dcuMinSignOffProcess, String key, BpmnService bpmnService, String stagePrefix) {
    ...
    void setupMarkupFor(String PR, ProcessScenario dcuMinSignOffProcess) {
        ...
        when(dcuMinSignOffProcess.waitsAtUserTask("VALIDATE_TOPICS"))
                .thenReturn(task -> task.complete(withVariables(
                        "valid", true,
                        "DIRECTION", "FORWARD",
                        "Topics", POINTY_THINGS_TOPIC,
                        "DefaultPolicyTeamUUID", POINTY_THINGS_TOPIC_TEAM_UUID,
                        "DefaultPolicyTeamName", POINTY_THINGS_TOPIC_TEAM_NAME
                )));
    }
